...
export const ROOMS = [
  ...
  },
  {
    ...
    subtitle: 'Packet Filtering & Network Security',
    icon: Users,
    desc: 'Defend the server! Rapidly BLOCK or ALLOW network packets before malicious traffic gets through.',
  ...
  },
  {
    ...
    subtitle: 'AI Forensics — Real vs Fake',
    icon: Bot,
    desc: 'Rapidly classify intercepted content as REAL or AI-GENERATED before deepfakes breach the network.',
    category: 'ai-threat',
